...
func (t Training) meanSpeed() float64 {
	...
	if t.Duration.Hours() == 0 {
		panic("Время выпонения упражнений не может быть равно 0")
	}
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (SpeadMs/heightMetr)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours())
}
